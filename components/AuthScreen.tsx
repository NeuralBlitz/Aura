      ...
      <div className="w-full max-w-md metallic-card blue rounded-[3rem] p-6 md:p-10 relative z-10 animate-fade-in shadow-2xl">
        ...
        <div className="space-y-3">
          <button
            ...
            type="button"
            className="w-full py-4 bg-white text-black rounded-2xl font-black text-xs uppercase tracking-[0.1em] hover:bg-gray-100 transition-all flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            type="button"
            className="w-full py-4 bg-black border border-white/20 text-white rounded-2xl font-black text-xs uppercase tracking-[0.1em] hover:bg-neutral-900 transition-all flex items-center justify-center gap-3"
          >
