  ...
  return (
    <div className="pt-6 pb-48 px-6 max-w-2xl mx-auto animate-fade-in font-sans">
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          <h1 className="text-4xl font-black text-white tracking-tighter italic">Echo Mirror</h1>
          <p className="text-xs text-neutral-500 font-bold uppercase tracking-[0.2em] mt-1">Psychometric Radar</p>
        </div>
      </div>
