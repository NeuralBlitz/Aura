...
const BrowserView: React.FC = () => {
  ...
  return (
    <div className="flex h-full bg-[#050505] font-sans overflow-hidden">
      {/* Sidebar: Tabs */}
      <div className="w-64 bg-black/50 border-r border-white/5 flex flex-col shrink-0">
         <div className="p-6">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#080808]">
         ...
         <div className="flex-1 flex overflow-hidden">
            ...
            {/* DevTools Inspector */}
            {showDevTools && (
               <div className="w-80 bg-[#0A0A0A] border-l border-white/5 flex flex-col animate-slide-left">
