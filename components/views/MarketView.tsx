...
const MarketView: React.FC = () => {
  ...
  const fetchMarketData = async () => {
    try {
      ...
      if (response.ok) {
         ...
         setBtcPrice(marketData.btc || 65420.50);
      } else {
         // Fallback mock data
         setData([
            { time: '00:00', BTC: 65000 },
            { time: '04:00', BTC: 65200 },
            { time: '08:00', BTC: 64800 },
            { time: '12:00', BTC: 65500 },
            { time: '16:00', BTC: 66000 },
            { time: '20:00', BTC: 65420 }
         ]);
      }
    } catch (e) {
      console.error(e);
  ...
  return (
    <ModuleLayout title="Fin.Terminal" subtitle="Market Analysis & Trading" status="MARKETS OPEN" icon={Activity} color="emerald">
