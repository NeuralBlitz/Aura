...
const NewsView: React.FC = () => {
  ...
  return (
    <div className="flex h-full bg-[#050505] animate-fade-in font-sans overflow-hidden">
      {/* Sidebar Navigation */}
      <div className="w-60 bg-black/50 border-r border-white/5 flex flex-col p-6 shrink-0">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
         ...
         <div className="h-16 border-b border-white/5 flex items-center justify-between px-8 bg-black/40 backdrop-blur-md shrink-0">
            <div className="flex items-center gap-4">
               ...
               <h1 className="text-lg font-black text-white italic tracking-tight">
                  {viewMode === 'reader' ? 'Secure Reader Link' : 'Global Intelligence Stream'}
               </h1>
            </div>
            <button onClick={fetchNews} disabled={isLoading} className="p-2 bg-white/5 rounded-lg text-blue-500 hover:bg-blue-500/20 transition-all">
         ...
         <div className="flex-1 overflow-y-auto p-8 no-scrollbar">
            {viewMode === 'reader' && readingItem ? (
               <div className="max-w-3xl mx-auto animate-slide-up">
                  <div className="metallic-card blue rounded-[3rem] p-12 bg-black/40">
                     ...
                     <h1 className="text-4xl font-black text-white mb-8 leading-tight tracking-tight">{readingItem.title}</h1>
               ...
               <div className="space-y-8">
                  ...
                  {activeCategory === 'All' && (
                     <div className="h-64 metallic-card blue rounded-[2.5rem] p-6 bg-blue-900/5 mb-8">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                     {news.filter(n => {
                        ...
                        <div 
                           ...
                           className="group relative metallic-card bg-neutral-900/40 hover:bg-neutral-800/60 rounded-[2rem] p-6 cursor-pointer transition-all flex flex-col sm:flex-row gap-6 animate-slide-up"
