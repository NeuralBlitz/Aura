  ...
  return (
    <div className="pt-6 pb-48 px-6 max-w-2xl mx-auto animate-fade-in font-sans">
      <div className="flex items-center gap-4 mb-10">
        <div className="p-4 bg-red-600/10 border border-red-500/20 rounded-[1.8rem] shadow-xl">
           <Lock className="w-8 h-8 text-red-500" />
        </div>
        <div>
          <h1 className="text-4xl font-black text-white tracking-tighter italic">Cipher-X</h1>
          <p className="text-xs text-neutral-500 font-bold uppercase tracking-[0.2em] mt-1">Neural Steganography</p>
        </div>
      </div>
