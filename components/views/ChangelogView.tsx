...
const ChangelogView: React.FC = () => {
  ...
  return (
    <ModuleLayout title="System Logs" subtitle="Aura Substrate Evolution" status="STABLE" icon={GitMerge} color="orange">
        ...
        <div className="w-64 bg-black/40 backdrop-blur-xl border-r border-white/5 flex flex-col shrink-0">
           <div className="p-6">
              <div className="flex items-center gap-3 text-orange-500 mb-6">
                 ...
                 <h2 className="text-sm font-black uppercase tracking-widest text-white">Changelog</h2>
              </div>
           ...
           <div className="flex-1 overflow-y-auto px-3 space-y-1">
              <button className="w-full flex items-center justify-between p-3 rounded-xl transition-all bg-orange-900/20 text-orange-400 border border-orange-500/20">
                 <div className="flex items-center gap-3"><GitMerge className="w-4 h-4" /><span className="text-xs font-bold">Releases</span></div>
              </button>
              <button className="w-full flex items-center justify-between p-3 rounded-xl transition-all text-neutral-500 hover:bg-white/5 hover:text-white border border-transparent">
                 <div className="flex items-center gap-3"><MessageSquare className="w-4 h-4" /><span className="text-xs font-bold">Feedback</span></div>
              </button>
           </div>
        </div>
